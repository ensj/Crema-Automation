...
// The getRandomProduct initializes a token when it is called for the first time in each session.
// As the token can last up to 60 days, there needs to be a way to contain it elsewhere once produced.
var token;
